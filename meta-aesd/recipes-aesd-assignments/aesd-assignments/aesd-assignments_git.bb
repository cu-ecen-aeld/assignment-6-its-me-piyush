...
SRC_URI = "git@github.com:cu-ecen-aeld/assignments-3-and-later-its-me-piyush.git;protocol=ssh;branch=main"
...
do_install () {
    ...
    # Optional start/stop helper script (nice for grading / debugging)
